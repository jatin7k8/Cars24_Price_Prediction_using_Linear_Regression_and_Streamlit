...
from tblib.pickling_support import pickle_exception

cars_df = pd.read_excel("D:\Github practice\oct_mlps\jatin\cars24-car-price.xlsx")

st.write(

    """
    # Cars 24 Used Car Price Predicitions
    """
)
...
def model_pred(fuel_type, transmission_type, engine, seats):
    ...
    with open('D:\Github practice\oct_mlps\jatin\car_pred','rb') as file:

        reg_model = pickle.load(file)

        input_feature = [[2018.0, 1, 4000, fuel_type, transmission_type, 19.70, engine, 86.30, seats]]
